...
func (slf *FCT) PtrFloat64(defaultValue ...float64) *float64 {
	if slf != nil {
		return fm.Ptr(slf.vd.InexactFloat64())
	}
...
func (slf *FCT) PtrFloor(opt ...interface{}) *FCT {
	...
	if slf != nil {
		return fm.Ptr(slf.Floor(places...))
	}

	if defaultValue != nil {
		return fm.Ptr(defaultValue.Floor(places...))
	}
...
func (slf *FCT) PtrCeil(opt ...interface{}) *FCT {
	...
	if slf != nil {
		return fm.Ptr(slf.Ceil(places...))
	}

	if defaultValue != nil {
		return fm.Ptr(defaultValue.Ceil(places...))
	}
